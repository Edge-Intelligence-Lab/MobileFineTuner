...
JSONL="${MMLU_JSONL:-$REPO_ROOT/runs/mmlu_jsonl_gpt2_s128/train.jsonl}"
WT2_DATA_DIR="${WT2_DATA_DIR:-}"
PRETRAINED="${GPT2_SMALL_MODEL_DIR:-}"
...
if [ "$SMOKE" = "1" ]; then
  ...
  PRETRAINED="${PRETRAINED:-$(mf_resolve_model_dir gpt2_small "$SCRIPT_DIR/pretrained")}"
